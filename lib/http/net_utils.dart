...
Observable<WanResponse<T>> requestWithRx<T>(Method method, String url,
    {dynamic params,
...
Future<WanResponse<T>> request<T>(
  Method method,
  String url, {
  dynamic params,
  Map<String, dynamic> queryParams,
...
Future<WanResponse<T>> _request<T>(String method, String url,
  ...
  try {
    ...
    print(e);
    return WanResponse(data: null, errorCode: -1, errorMsg: e.toString());
  }
}
